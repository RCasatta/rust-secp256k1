...
static int nonce_function_bip340(unsigned char *nonce32, const unsigned char *msg, size_t msglen, const unsigned char *key32, const unsigned char *xonly_pk32, const unsigned char *algo, size_t algolen, void *data) {
    ...
    if (algolen == sizeof(bip340_algo)
            && rustsecp256k1_v0_4_1_memcmp_var(algo, bip340_algo, algolen) == 0) {
        rustsecp256k1_v0_4_1_nonce_function_bip340_sha256_tagged(&sha);
    } else {
        rustsecp256k1_v0_4_1_sha256_initialize_tagged(&sha, algo, algolen);
    }
...
static void rustsecp256k1_v0_4_1_schnorrsig_challenge(rustsecp256k1_v0_4_1_scalar* e, const unsigned char *r32, const unsigned char *msg, size_t msglen, const unsigned char *pubkey32)
{
...
int rustsecp256k1_v0_4_1_schnorrsig_sign_internal(const rustsecp256k1_v0_4_1_context* ctx, unsigned char *sig64, const unsigned char *msg, size_t msglen, const rustsecp256k1_v0_4_1_keypair *keypair, rustsecp256k1_v0_4_1_nonce_function_hardened noncefp, void *ndata) {
    ...
    rustsecp256k1_v0_4_1_schnorrsig_challenge(&e, &sig64[0], msg, msglen, pk_buf);
...
int rustsecp256k1_v0_4_1_schnorrsig_sign(const rustsecp256k1_v0_4_1_context* ctx, unsigned char *sig64, const unsigned char *msg32, const rustsecp256k1_v0_4_1_keypair *keypair, unsigned char *aux_rand32) {
    return rustsecp256k1_v0_4_1_schnorrsig_sign_internal(ctx, sig64, msg32, 32, keypair, rustsecp256k1_v0_4_1_nonce_function_bip340, aux_rand32);
}

int rustsecp256k1_v0_4_1_schnorrsig_sign_custom(const rustsecp256k1_v0_4_1_context* ctx, unsigned char *sig64, const unsigned char *msg, size_t msglen, const rustsecp256k1_v0_4_1_keypair *keypair, rustsecp256k1_v0_4_1_schnorrsig_extraparams *extraparams) {
    rustsecp256k1_v0_4_1_nonce_function_hardened noncefp = NULL;
    void *ndata = NULL;
    VERIFY_CHECK(ctx != NULL);

    if (extraparams != NULL) {
        ARG_CHECK(rustsecp256k1_v0_4_1_memcmp_var(extraparams->magic,
                                       schnorrsig_extraparams_magic,
                                       sizeof(extraparams->magic)) == 0);
        noncefp = extraparams->noncefp;
        ndata = extraparams->ndata;
    }
    return rustsecp256k1_v0_4_1_schnorrsig_sign_internal(ctx, sig64, msg, msglen, keypair, noncefp, ndata);
}

int rustsecp256k1_v0_4_1_schnorrsig_verify(const rustsecp256k1_v0_4_1_context* ctx, const unsigned char *sig64, const unsigned char *msg, size_t msglen, const rustsecp256k1_v0_4_1_xonly_pubkey *pubkey) {
    ...
    rustsecp256k1_v0_4_1_schnorrsig_challenge(&e, &sig64[0], msg, msglen, buf);

    /* Compute rj =  s*G + (-e)*pkj */
    rustsecp256k1_v0_4_1_scalar_negate(&e, &e);
    rustsecp256k1_v0_4_1_gej_set_ge(&pkj, &pk);
    rustsecp256k1_v0_4_1_ecmult(&rj, &pkj, &e, &s);
