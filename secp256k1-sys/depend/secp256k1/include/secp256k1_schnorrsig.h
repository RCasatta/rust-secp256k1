 ...
 *             rustsecp256k1_v0_4_1_nonce_function_bip340 is used
...
typedef struct {
    ...
    void* ndata;
} rustsecp256k1_v0_4_1_schnorrsig_extraparams;
 ...
 *  rustsecp256k1_v0_4_1_tagged_sha256 and then sign the hash. Tagged hashing allows
 ...
 *
 *  Same arguments as rustsecp256k1_v0_4_1_schnorrsig_sign except that it allows signing
 ...
 */
SECP256K1_API int rustsecp256k1_v0_4_1_schnorrsig_sign_custom(
    const rustsecp256k1_v0_4_1_context* ctx,
    unsigned char *sig64,
    const unsigned char *msg,
    size_t msglen,
    const rustsecp256k1_v0_4_1_keypair *keypair,
    rustsecp256k1_v0_4_1_schnorrsig_extraparams *extraparams
